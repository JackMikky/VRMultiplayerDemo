...
namespace XRMultiplayer
{
    ...
    public class RoomMusic : NetworkBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                Utils.LogWarning(
                    "No music clips found in RoomMusic script. Please add some music clips to the RoomMusic script.");
                enabled = false;
                return;
            }
        ...
        public override void OnNetworkSpawn()
        {
            ...
            else
            {
                if (m_IsPlayingNetworked.Value)
                {
                    ...
                    GetCurrentSongPercFromOwnerRpc();
                }
        ...
        private void PickRandomSong()
        {
            ...
            while (tries > 0)
            {
                ...
                m_AudioSource.clip = m_MusicClips[randomSongId];
