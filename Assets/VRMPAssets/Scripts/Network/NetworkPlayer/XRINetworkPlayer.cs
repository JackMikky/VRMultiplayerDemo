...
namespace XRMultiplayer
{
    ...
    public class XRINetworkPlayer : NetworkBehaviour
    {
        ...
        /// </summary>
        //public string playerVoiceId
        //{
        //    get => m_PlayerVoiceId.Value.ToString();
        //}

        //readonly NetworkVariable<FixedString128Bytes> m_PlayerVoiceId = new("", NetworkVariableReadPermission.Everyone,
