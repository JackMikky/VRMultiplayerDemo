...
namespace XRMultiplayer
{
    ...
    public class XRINetworkGameManager : MonoBehaviour
    {
        ...
        /// </summary>
        public bool autoConnectOnLobbyJoin
        {
        ...
        /// <summary>
        /// Action for when connection Success.
        /// </summary>
        public Action<string> OnConnectionSuccessAction;
        ...
        protected virtual async void Awake()
        {
            ...
            if (TryGetComponent(out m_SessionManager))
            {
        ...
        public virtual async void CreateNewLobby(string roomName = null, bool isPrivate = false,
